...
#tfsec:ignore:aws-s3-enable-bucket-logging 로깅은 log_bucket 입력으로 활성화. 로그 버킷 자신은 순환 로깅 제외 (ADR-006)
#tfsec:ignore:aws-s3-encryption-customer-key CMK 는 kms_key_arn 으로 선택. 기본은 SSE-S3 (ADR-002)
